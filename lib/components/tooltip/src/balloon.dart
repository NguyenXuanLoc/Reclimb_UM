...
class _BalloonShape extends ShapeBorder {
  ...
  Path getOuterPath(Rect rect, {TextDirection? textDirection}) {
    ...
    }else if (tooltipDirection == TooltipDirection.center) {
      targetCenter = rect.center.translate(arrowLength, 0);
    }
    // print(targetCenter);
  ...
  void paint(Canvas canvas, Rect rect, {TextDirection? textDirection}) {
    Paint paint = Paint()
      ...
      ..color = borderWidth == 0 ? const Color(0x00000000) : borderColor
