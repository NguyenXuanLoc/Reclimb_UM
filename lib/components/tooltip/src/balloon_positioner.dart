...
class __BallonPositionerState extends State<_BallonPositioner> {
  ...
  Widget build(BuildContext _) {
    ...
    try {
      ...
      } else if (widget.tooltipDirection == TooltipDirection.center) {
        tipTarget = renderBox.size.center(zeroOffset);
      }
    } catch (e) {
      return Container();
    }
    ...
    final balloon = CustomSingleChildLayout(
      ...
      child: Stack(
        ...
        children: <Widget>[
          Positioned(
            child: Container(
              margin: widget.tooltipMargin, // Todo
              key: _ballonKey,
              child: widget.child,
            ),
          ),
  ...
  Offset getPositionForChild(
    ...
    if (widget.tooltipDirection == TooltipDirection.up) {
      ...
      ballonOffset = centerPosition.translate(0, yOffset);
        ...
        widget.tooltipDirection == TooltipDirection.center) {
